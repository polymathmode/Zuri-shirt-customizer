...
const DesignPreview = ({
  ...
  const drawTShirt = async (ctx) => {
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        tshirtImage.onerror = (e) => {
          setImageError('Failed to load t-shirt image');
          reject(e);
        };
        // Using a CORS-friendly image URL
        tshirtImage.src = "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500";
      });
      ...
      console.error('Error in drawTShirt:', error);
      setImageError('Error loading t-shirt image');
    }
  };
  ...
  return (
    <div className="relative flex flex-col">
      {imageError && (
        <div className="absolute top-2 left-2 bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded">
          {imageError}
        </div>
      )}
